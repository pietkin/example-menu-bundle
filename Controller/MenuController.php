...
use Pietkin\ExampleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PietkinExampleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("PietkinExampleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PietkinExampleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("PietkinExampleMenuBundle:Menu:edit.html.twig")
     */
